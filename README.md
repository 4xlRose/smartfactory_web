...
This repository contains a turborepo for all frontend web projects that run at Smart Factory.
...
- [web](/apps/camera_server_web): a [Next.js](https://nextjs.org/) app

### Packages

- [ui](/packages/ui): the shared component library for all projects
- [camera_server_api](/packages/camera_server_api): an API library to connect to a [camera_server](https://github.com/SmartFactory-Tec/camera_server)
  instance
- [eslint-config-custom](/packages/eslint-config-custom): `eslint` configurations (includes `eslint-config-next` and `eslint-config-prettier`)
